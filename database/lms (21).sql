...
(11, 'Computing essentials', 'making IT work for you: Introductory 2023', 'Timothy J. O\'Leary', '', '', '978-1-26526321-8', '', 'Computer File', 'Braille', '', 'New York', 'The McGraw-Hill Companies', '0000-00-00', '2023', '27.5 cm', '', '390pages', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '683902736ce86_heh.png'),
...
(820, 7, 'BOOK0000014', '', 'English reading proficiency in comprehension of grade VI pupils in Jalandoni Memorial Elementary School ', 'Borrowed', 'Fil-R 0840 G661 2023', 'General Circulation', '2023-07-18', '', '', '', 0, 0, 0, 'sublocation', 'vendor 1', 'funding source', 5, ''),
(821, 7, 'BOOK0000015', '', 'English reading proficiency in comprehension of grade VI pupils in Jalandoni Memorial Elementary School ', 'Available', 'Fil-R 0840 G661 2023', 'General Circulation', '2023-07-18', '', '', '', 0, 0, 0, 'sublocation', 'vendor', 'funding source 1', 5, ''),
(822, 7, 'BOOK0000016', '', 'English reading proficiency in comprehension of grade VI pupils in Jalandoni Memorial Elementary School ', 'Available', 'Fil-R 0840 G661 2023', 'General Circulation', '2023-07-18', '', '', '', 0, 0, 0, 'sublocation', 'vendor', 'funding source', 5, ''),
...
('admin1s', 'www', 'w', 'w', '', '', '', 'vonjohn.suropia@students.isatu.edu.ph', '09111111111', NULL, NULL, NULL, '2007-06-01', '', '', '', '', '3', '', 'active', 's', 's', 'student', 'approved'),
...
--
ALTER TABLE `book`
  MODIFY `book_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=322;

--
-- AUTO_INCREMENT for table `book_copies`
--
ALTER TABLE `book_copies`
  MODIFY `book_copy_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=853;
...
--
ALTER TABLE `coauthor`
  MODIFY `co_author_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `subject`
  MODIFY `subject_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=692;
