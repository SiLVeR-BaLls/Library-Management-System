<?php
    ...
    // Query to get book titles, borrow_id, borrow_date, due_date, and IDno where return_date is NULL for the logged-in user
    $query = "
        SELECT DISTINCT b.borrow_id, c.B_title, b.borrow_date, b.due_date, b.IDno
        FROM borrow_book b
        JOIN book_copies c ON b.book_copy = c.book_copy
        WHERE b.return_date IS NULL AND b.IDno = ?
...
<div class="flex flex-1">
    ...
    <div class="flex flex-col flex-1">
        ...
        <div class="container mx-auto px-4 py-6">
            <h2 class="text-3xl font-semibold mb-4 text-center">Your Borrowed Books</h2>
            ...
            <table class="min-w-full table-auto bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <tbody id="bookTableBody">
                    ...
                    if ($result && $result->num_rows > 0) {
                        ...
                        echo "<tr><td class='py-2 px-4 text-center' colspan='3'>No borrowed books available.</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
