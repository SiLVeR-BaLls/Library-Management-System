...
<body style="color : <?= $text1 ?>; background: <?= $background ?>;" class="h-full flex flex-col items-center justify-center bg-<?= $background ?>">
    ...
    <!-- Main Content -->
    <main style=" background: <?= $sidebar ?>;" class="flex-grow max-w-full max-w-2xl px-4 m-5 rounded-lg shadow-xl">
        ...
        <form id="themeForm" action="" enctype="multipart/form-data">
            <div class="flex">
                <div class="flex flex-col">
                    ...
                    <div style="color: <?= $text1 ?>;" class="flex justify-end p-2 gap-4">
                    <button type="button" onclick="location.reload()" class="btn px-6 py-3 m-2 bg-red-500 text-white rounded-md">
                        <i class="fas fa-rotate-right"></i> <!-- Reload icon -->
                        </button>
                        <button type="button" onclick="saveTheme()" class="btn px-6 py-3 m-2 bg-green-500 text-white rounded-md">
                            <i class="fas fa-save"></i> <!-- Save icon -->
                        </button>
                        <button type="button" onclick="window.location.href='index.php'" class="btn px-6 py-3 m-2 bg-blue-500 text-white rounded-md">
