            ...
            <div class="w-full h-auto mx-auto"> <!-- This will take 100% of the container width and 80% of the viewport height -->
                ...
                <div class="container mx-auto px-4 py-6">
                    <?php if ($range): ?>
                        <?php
                        if ($range == "Other") {
                            echo "<a href='report.php' class='mb-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded inline-block'>Return to Report</a>";
                        } else {
                        ...
                        <?php
                        if ($range == "Other") {
                            $sql = "SELECT b.book_id, b.B_title, bc.callNumber
                            FROM book_copies bc
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                echo "<thead><tr class='bg-gray-100'><th class='border border-gray-300 p-2'>Call Number</th><th class='border border-gray-300 p-2'>Title</th><th class='border border-gray-300 p-2'>Day</th><th class='border border-gray-300 p-2'>Week</th><th class='border border-gray-300 p-2'>Month</th><th class='border border-gray-300 p-2'>Year</th></tr></thead><tbody>";
                                ...
                                echo "<td class='border border-gray-300 p-2 font-bold' colspan='2'>Total</td>";
